...
class Strategy:
    ...
    def on_historical_bars_response(self, response: common.HistoricalBarsResponse) -> None: ...
    def on_historical_bars_request_failed(
        self, failure: common.HistoricalBarsRequestFailure
    ) -> None: ...
