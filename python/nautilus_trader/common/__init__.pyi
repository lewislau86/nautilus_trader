...
class DataActor:
    ...
    def on_historical_bars_response(self, response: HistoricalBarsResponse) -> None: ...
    def on_historical_bars_request_failed(self, failure: HistoricalBarsRequestFailure) -> None: ...
    ...
    def subscribe_bar_topic(
        self, topic: str, handler: collections.abc.Callable[[model.Bar], None], priority: int = 0
    ) -> None: ...
    def unsubscribe_bar_topic(
        self, topic: str, handler: collections.abc.Callable[[model.Bar], None]
    ) -> None: ...
...
class HistoricalBarsBatch:
    ...
    def bars(self) -> list[model.Bar]: ...

@typing.final
class HistoricalBarsOutcome:
    @property
    def is_validated(self) -> bool: ...
    @property
    def error(self) -> str | None: ...
    def aggregate_bar_types(self) -> list[model.BarType]: ...
    def aggregates(self) -> list[HistoricalBarsBatch]: ...
...
class HistoricalBarsRequestFailure:
    ...
    @property
    def requested_client_id(self) -> model.ClientId | None: ...
    @property
    def bar_type(self) -> model.BarType: ...
    @property
...
class HistoricalBarsResponse:
    ...
    def ts_init(self) -> int: ...
    @property
    def historical_outcome(self) -> HistoricalBarsOutcome | None: ...
    def params(self) -> dict | None: ...
    def bars(self) -> list[model.Bar]: ...
